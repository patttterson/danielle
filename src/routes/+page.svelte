...
<div class="banner">
	<div class="banner-left">
		<img src={tetrio} alt="TETR.IO" class="tetrio-logo" />
		<div class="subtitle">Amateur Weeklies</div>
	</div>

	<div class="banner-center">
		<img src={taws} alt="icon" class="center-icon" />
	</div>

	<div class="banner-right">
		<a
			href="https://discord.gg/tetr-io-amateur-weeklies-599005375907495936"
			class="social-btn"
			aria-label="TAWS Discord"
		>
		...
		<a
			href="https://youtube.com/@tetrioamateurweeklies"
			class="social-btn"
			aria-label="TAWS Youtube"
		>
